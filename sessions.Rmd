...
Next session: **Using UGA’s Ciment servers, January 14th, 2021 at 5PM on Zoom**. 

<!-- Registration link and ZOOM link will be posted here before December 5th. -->

Registration to the event [here](https://www.eventbrite.com/e/using-grenoble-university-computing-servers-with-r-tickets-135986361869).

Link to Zoom [here](https://univ-grenoble-alpes-fr.zoom.us/j/94572905155?pwd=L0FNM3lyOVR2bzVCRW1jQlo5WWFtdz09).
...
- Using UGA servers with R: [GRICAD slides](https://bouttiep.gricad-pages.univ-grenoble-alpes.fr/slides/20210114_group-r.html)
