...
Make sure you have the latest versions of RStudio, styler, lintr, and Roxygen packages installed.", "A. Arnaud & J. Arbel",
  ...
  "26/04/2018", "8/10", "Parallel computing", "'Compute as you sew' is a short presentation that demystifies parallelism. It defines simple parallel programming paradigms based on an understandable model of the computer. It shows concrete examples of collaborative tasks quoted from sewing domain. A short R implementation is offered and limits of the approach are discussed. 'Compute as you sew' will definitely changes your point of view on parallelism (and on sewing). It will make your code greater, more efficient, more easy to read or to transpose on modern computers and on HPC infrastructures. It will for sure make your (R) life better. It could also change the world but it cannot do that without you.", "F. Chuffart & L. Viry",
  "24/05/2018", "9/10", "Out-of-memory matrices", "In this session, I will present R package bigstatsr. R package bigstatsr provides a special class of matrix whose data is stored on the disk instead of the RAM, but you can still access the data almost as if it were in memory. It is particularly useful is you have a large matrix to analyze but not enough RAM on your computer. It can still be useful for matrices that fit in your RAM because package bigstatsr provides very efficient and parallelized algorithms (have you ever found `cor` or `svd` slow?). I will present the statistical and helper functions that are provided by package bigstatsr for this kind of matrices.", "F. Privé",
