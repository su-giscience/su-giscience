...
<!-- You can register to session 14 about package {drake} [there](https://www.eventbrite.fr/e/billets-grenoble-rug-working-session-n14-manage-your-workflow-with-package-drake-53004382535). -->

<!-- Attendance is totally free but registration is mandatory and is on a first come first serve basis. -->

Materials of the presentation are available [here](presentation/drake.pdf).
