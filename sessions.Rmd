...
Next session: **Organizing a data challenge in R**, on **January 30th from 16:00 to 18:00 @IMAG, salle séminaire 2**.

Attendance is totally free but registration is mandatory and is on a first come first serve basis.

Registration to the event [here](https://www.eventbrite.com/e/r-in-grenoble-organizing-a-data-challenge-in-r-tickets-90788993323).

**[Link to the event's codalab data challenge](https://competitions.codalab.org/competitions/21950?secret_key=865fa76d-fd94-4851-89af-3743f0cf2e4d)**
