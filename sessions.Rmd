...
Next session: **Spatial data with packages {sf} and {raster}**, on **October 17th from 16:00 to 18:00 @IMAG**. You can register to the event [here](https://www.eventbrite.fr/e/billets-r-in-grenoble-spatial-data-with-packages-sf-and-raster-76135450181).
