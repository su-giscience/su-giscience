...
<!-- You can register to session 12 about image processing with R package {imager} [there](https://www.eventbrite.fr/e/billets-grenoble-rug-working-session-n12-image-processing-with-imager-50849757995). -->

Slides of the presentation are available at dahtah.github.io/imager/intro_slides.
...
program <- tribble(
  ...
  "11/04/2019", "18/20", "R Markdown", "TODO", "M. Crispino & J. Arbel",

  "16/05/2019", "19/20", "Data manipulation with package {dplyr}", "TODO", "M. Blum & ?",

  "13/06/2019", "20/20", "Data vizualisation with package {ggplot2}", "TODO", "? & F. Privé"
