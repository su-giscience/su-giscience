...
- During the second part of the session, people could ask and answer some questions about specific problems they encounter when coding in R. During this time, ~~beers,~~ cocktails and snacks will be offered by the [Grenoble Alpes Data Institute](https://data-institute.univ-grenoble-alpes.fr/).
...
- If we manage to invite some well-known speakers, we could host some special seminars. Normally, [Romain François](https://romain.rbind.io/) will come give a talk about [Shiny](https://shiny.rstudio.com/) in the second semester.
...
- A [gitter](https://gitter.im/R-in-Grenoble) is available to help people discuss with each other. You can see directly the chat rooms on this website. What about making a slack team to communicate?
